  ...
  return (
    <div className="flex flex-row items-start gap-6 w-full">
      ...
      <button
        ...
        onClick={onCancel}
        disabled={submitting}
        className="flex items-center gap-2 border border-[#998C5F] bg-[rgba(255,234,158,0.10)] px-6 sm:px-10 py-4 h-[60px] shrink-0 hover:bg-[rgba(255,234,158,0.18)] active:bg-[rgba(255,234,158,0.25)] transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#998C5F] disabled:opacity-50"
